package com.quickefi.retailapp.domain.api;
...
public class EndPoints {
   ...
   //private static final String API_URL                  = "http://77.93.198.186/v1.2/";    // staging
    private static final String API_URL                  = "http://obscure-hamlet-49624.herokuapp.com/api/";    // mock
    public static final String accesstokenonfidomock = "onfido mock token. Specific for user id";
    public static final String CONTACT=API_URL.concat("contacts");
    ...
    public static final String NAVIGATION_DRAWER        = API_URL.concat("%d/navigation_drawer/women"); // TODO 'women' is just a group which can differentiate drawer items for different cases.
