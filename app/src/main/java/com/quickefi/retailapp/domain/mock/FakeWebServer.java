...
package com.quickefi.retailapp.domain.mock;
...
import com.quickefi.retailapp.model.entities.ProductCategoryModel;
...
public class FakeWebServer {
    ...
    public void addUsertoMongo()
    {
        //TODO get mongoose client and do crud on local
        //testuserid=2
        int tkuser=2;
        String url = String.format(EndPoints.USER_SINGLE, tkuser);
        JsonRequest req = new JsonRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                /*try {
                    ...
                    System.err.println(e, "Unable to get that basic contact from mongo heroku");
                    //showNotifyCount(0);
                }*/
            }
  ...
  deleteContact(contactId: String): void {
    ...
    public void getAllFurnitures() {
        ...
        CenterRepository.getCenterRepository().setMapOfProductsInCategory(productMap);
        //CenterRepository.getCenterRepository().setMapOfProductsInCategory();
