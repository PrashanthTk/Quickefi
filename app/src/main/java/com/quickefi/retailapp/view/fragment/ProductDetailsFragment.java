...
import com.quickefi.retailapp.model.CenterRepository;
import com.quickefi.retailapp.model.entities.Money;
import com.quickefi.retailapp.model.entities.Product;
import com.quickefi.retailapp.util.ColorGenerator;
...
import com.quickefi.retailapp.view.adapter.SimilarProductsPagerAdapter;
import com.quickefi.retailapp.view.customview.ClickableViewPager;
import com.quickefi.retailapp.view.customview.ClickableViewPager.OnItemClickListener;
import com.quickefi.retailapp.view.customview.LabelView;
import com.quickefi.retailapp.view.customview.TextDrawable;
import com.quickefi.retailapp.view.customview.TextDrawable.IBuilder;
...
public class ProductDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.findViewById(R.id.add_item).setOnClickListener(
                new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        // Take owner and renter details and create Order Instance.
                        // Create a new fragment for payment and only after that we make the api call to api/orders/:id
    ...
    public void fillProductData() {
        ...
        if (!isFromCart) {
            ...
            String sellCostString = Money.dollars(
